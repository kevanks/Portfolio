$(() => {
  ...
  const $pro1Img = $('<img>').attr('src', 'https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg').appendTo($pro1);
  ...
  const $pro2Img = $('<img>').attr('src', 'https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg').appendTo($pro2);
  ...
  const $pro3Img = $('<img>').attr('src', 'https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg').appendTo($pro3);
  ...
  const $pro4Img = $('<img>').attr('src', 'https://www.generationsforpeace.org/wp-content/uploads/2018/03/empty.jpg').appendTo($pro4);
